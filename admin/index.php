        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <?php
                               $query=mysqli_query($conn,"select * from property where property='project'");
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <?php
                               $query=mysqli_query($conn,"select * from property where property='resale'");
                                $count1=mysqli_num_rows($query);
                            ?>
                                    <h3><?php echo $count1; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php
                               $query=mysqli_query($conn,"select * from property where property='rent'");
                                $count1=mysqli_num_rows($query);
                            ?>
                                    <h3><?php echo $count1; ?></h3>
