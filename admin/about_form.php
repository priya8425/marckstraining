...
// } 
    if(isset($_POST['submit']))
    {
        ...
        $query = "INSERT INTO `about`(`name`,`description`, `image`) VALUES ('$name','$description','$image')";
        if (mysqli_query($conn, $query)){
          echo "<script> alert ('New record has been added successfully !');window.location='about.php'</script>";
       } else {
