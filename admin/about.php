...
if(isset($_GET['delid'])){
  ...
  $dnk=$_FILES['image']['tmp_name'];
    ...
    $sql="UPDATE `about` SET `name`='$name',`description`='$description',`image`='$image' WHERE id='$id'";
    if (mysqli_query($conn, $sql)){
      // header("location:new_project.php");
      echo "<script>alert('Successfully Updated');</script>";
   } else {
      echo "<script> alert ('connection failed !');window.location.href='about.php'</script>";
   }
  }
...
<div class="wrapper">
   ...
   <div class="content-wrapper">
    ...
    ?>
                      <tr>
                       ...
                       <button  type="button" class="btn btn-primary btn-rounded btn-icon aboutedit btn-sm" data-toggle="modal" data-id='<?php echo $arr['id']; ?>'
                        style="color: aliceblue"> <i class="fas fa-pen"></i> </button>
                                                               
                        <a href="about.php?delid=<?php echo $arr['id']; ?>"><button type="button" class="btn btn-danger btn-rounded btn-icon btn-sm"  style="color: aliceblue"> <i class="fas fa-trash"></i> </button></a>
  ...
  <div class="modal-dialog">
    ...
    <button type="button" class="btn-close btn btn-secondary" data-dismiss="modal">Close</button>
      <button type="submit" class="btn btn-primary" name="aboutedit1">Save changes</button>
    </div>
  </form>
  </div>
  </div>
