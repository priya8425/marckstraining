...
if(isset($_GET['delsr_no'])){
    ...
    $sql=mysqli_query($conn,"delete from about where id='$sr_no'");
    if($sql=1){
      header("location:trainning.php");
    }
  }
  
      if(isset($_POST['trainningedit1'])){
        $id=$_POST['id'];
      ...
      $loc="dist/img/".$image;
        ...
        $sql="UPDATE `trainning` SET `description`='$description',`image`='$image',`name`='$name' WHERE id='$id'";
...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
   ...
   <div class="content-wrapper">
    ...
    ?>
                    ...
                    <td><img src="dist/img/<?php echo $arr['image'];?>" style="height:150px; width:150px;"></td>
                    
                    
                    <td><?php echo $arr['name'];?></td>
                        <td>
                       
                       <button  type="button" class="btn btn-primary btn-rounded btn-icon trainningedit btn-sm" data-toggle="modal" data-id='<?php echo $arr['id']; ?>'
                        style="color: aliceblue"> <i class="fas fa-pen"></i> </button>
                                                               
                        <a href="trainning.php?delid=<?php echo $arr['id']; ?>"><button type="button" class="btn btn-danger btn-rounded btn-icon btn-sm"  style="color: aliceblue"> <i class="fas fa-trash"></i> </button></a>
  ...
  <div class="modal-dialog">
    ...
    <button type="button" class="btn-close btn btn-secondary" data-dismiss="modal">Close</button>
      <button type="submit" class="btn btn-primary" name="trainningedit1">Save changes</button>
    </div>
  </form>
  </div>
  </div>
 ...
 <script src="plugins/jquery/jquery.min.js"></script>
  ...
  <script>
    ...
    <script>
          ...
          $('.trainningedit').click(function(){
            let dnkk3 = $(this).data('id');
