...
// } 
    if(isset($_POST['submit']))
    {
        ...
        $query = "INSERT INTO `home_page`(`image`, `student_description`, `student_name`,`student_degree`) VALUES                   
         ('$image','$student_description','$student_name','$student_degree')";
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="student_description" placeholder="Enter ">
                    </div>
                  </div>
                </div>
                <!-- /.row -->
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="student name" placeholder="Enter Name">
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="student_degree" placeholder="Enter degree">
                    </div>
