...
if(isset($_GET['delcourse_id'])){
  $course_id=mysqli_real_escape_string($conn,$_GET['delcourse_id']);
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Abcourseout</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-header" style="padding:0px;">
                  ...
                  <div class="card-tools my-3" style="text-align:end;">
                    <a class="btn btn-primary" href="course_form.php" data-tt="tooltip" title=""
                      data-original-title="Click here to Add project" style="margin-right:20px;">Add courses</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    ?>
                      <tr>
                       ...
                       <button  type="button" class="btn btn-primary btn-rounded btn-icon courseedit btn-sm" data-toggle="modal" data-id='<?php echo $arr['course_id']; ?>'
                        ...
                        <a href="course.php?delcourse_id=<?php echo $arr['course_id']; ?>"><button type="button" class="btn btn-danger btn-rounded btn-icon btn-sm"  style="color: aliceblue"> <i class="fas fa-trash"></i> </button></a> </td>         
    </tr>     
