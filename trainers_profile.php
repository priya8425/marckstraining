...
if(isset($_POST['submit']))
    {
        ...
        if (mysqli_query($conn, $query)){
          echo "<script> alert ('New record has been added successfully !');window.location='trainers_profile.php'</script>";
       } else {
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          ...
          <br>
          <h3>About Software Trainers Profile</h3>
<br>    
          <h5>The quality and also usefulness connected with any kind of exercise program depends upon the actual Software Trainers.  Naresh IT Software Trainers are professionals, that are experienced and have real-world connection with the approval advancement. The actual interactive session carried out throughout the Course assists student for you to clear the style and also find out more rapidly.</h5>
          <h5>Having rich practical knowledge with technologies asking, providing alternatives for sophisticated and also varied difficulties for you to business, all our own software trainers are knowledgeable and also conversant regarding the newest scientific progress within their field of expertise, that eventually enables them to share technologies beyond study course articles and also guide the actual students with entire understanding of purposes.</h5>
          <br>
          <br>
        ...
        <!-- Popular Course Item -->
                    <div class="col-lg-4 course_box">
                        <div class="card" style="height:330px; width:250px; padding:10px;" >
                            <img class="card-img-top" src="admin/dist/img/credit/<?php echo $arr['image'];?>" style="height:200px;">
                            <div class="card-body text-center">
                            <div class="card-text"><?php echo $arr['trainer_name'];?></div>
                            <div class="card-text"><?php echo $arr['about'];?></div>
                            <div class="card-text"><?php echo $arr['experience'];?></div>
                        </div>
                    </div>
                </div>
                    <?php } ?>
        ...
        <br>
		<!-- row -->
        <h3>WHY OUR SOFTWARE TRAINERS</h3>
        <br>
        <br>
        <ul>
