...
if(isset($_POST['submit']))
    {
        ...
        if (mysqli_query($conn, $query)){
          echo "<script> alert ('New record has been added successfully !');window.location='courses.php'</script>";
       } else {
...
<?php 
  ...
  <div class="contact">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <h3>Learn Software Courses from the Expert Trainers.</h3>
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
              ...
              <tbody id="myTable">
                ...
                <tr>
                  ...
                  <td>
                    <a href="course_details.php?id=<?=$arr['course_id'];?>">
